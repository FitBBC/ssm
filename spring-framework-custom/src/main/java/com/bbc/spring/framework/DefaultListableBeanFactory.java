...
import com.bbc.spring.framework.aware.Aware;
...
import com.bbc.spring.framework.converter.IntegerTypeConverter;
import com.bbc.spring.framework.converter.StringTypeConverter;
import com.bbc.spring.framework.converter.TypeConverter;
import com.bbc.spring.framework.parser.XmlBeanDefinitionReader;
import com.bbc.spring.framework.resource.ClassPathResource;
import com.bbc.spring.framework.resource.Resource;
...
public class DefaultListableBeanFactory extends AbstractBeanFactory {
    ...
    public Object getBean(String name) {
        ...
        initObject(beanInstance, beanDefinition.getInitMethod());
     ...
     * @param initMethod
     */
    private void initObject(Object beanInstance, String initMethod) {
        ...
        try {
            ...
            for (BeanDefinition beanDefinition : beanDefinitions.values()) {
                ...
                if (clazz.isAssignableFrom(cls)) {
                    list.add(beanDefinition.getBeanName());
                }
            }
            return list;
    ...
    public <T> List<T> getBeansByType(Class<?> clazz) {
        try {
            ...
            for (BeanDefinition beanDefinition : beanDefinitions.values()) {
                Class cls = Class.forName(beanDefinition.getBeanClassName());
                if (clazz.isAssignableFrom(cls)) {
                    list.add((T) getBean(beanDefinition.getBeanName()));
                }
            }
            return list;
        } catch (ClassNotFoundException e) {
    ...
    public BeanDefinition getBeanDefinitionByBeanName(String name){
